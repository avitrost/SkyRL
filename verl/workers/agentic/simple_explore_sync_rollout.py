...
from verl.workers.agentic.scratchpad import ScratchpadAgentGroup
from verl.workers.agentic.simple_explore_sync import SimpleExploreAgentGroup
...
class SyncSimpleExploreRollout(BaseRollout):
    ...
    def generate_sequences(self, prompts: DataProto, **kwargs) -> DataProto | None:
        ...
        results = simple_explore_agent_group.run()
