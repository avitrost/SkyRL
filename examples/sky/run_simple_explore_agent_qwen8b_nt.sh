...
EXPERIMENT_NAME='simple-explore-training-qwen3-1.7b-32bsz-16r-temp0.6-10turn-easy'
DATA_PATH="dapo"
...
PYTHONUNBUFFERED=1 uv run --isolated --directory . --frozen --env-file .env -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.rollout.sampling_params.top_k=-1 \
    actor_rollout_ref.rollout.sampling_params.repetition_penalty=1 \
    ...
    reward_model.explore_only=False \
    ...
    trainer.log_val_generations=28 \
